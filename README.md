# Base project — Đề 002: Điều phối xe công tác

Starter gồm Gradle, Spring Boot/Spring AI dependencies, model/repository, corpus và seed data. 
\
Các package config, controller, dto, exception, service (rag/chat/langfuse/mcp) và tool chỉ 
là khung rỗng.

Sinh viên dùng credential cá nhân qua environment variables; không commit secret. Khởi động 
ứng dụng để JPA tạo bảng, sau đó chạy src/main/resources/seed_data.sql.
## Langfuse
